...
class TM_Settings
{
    ...
    public static function set_default_options(): void
    {
        ...
        $marketplace = wp_parse_args($existing_marketplace, array(
            ...
            'enable_sticky_category_nav' => 0,
            'enable_category_hero'       => 1,
            'hero_background_desktop_id' => 0,
            'hero_background_mobile_id'  => 0,
            'hero_overlay_color'         => '#ffffff',
            'hero_overlay_opacity'       => 74,
        ));
    ...
    public static function sanitize_marketplace(array $input): array
    {
        ...
        return array(
            ...
            'enable_sticky_category_nav' => TM_Helpers::maybe_bool($input['enable_sticky_category_nav'] ?? 0),
            'enable_category_hero'       => TM_Helpers::maybe_bool($input['enable_category_hero'] ?? 0),
            'hero_background_desktop_id' => absint($input['hero_background_desktop_id'] ?? 0),
            'hero_background_mobile_id'  => absint($input['hero_background_mobile_id'] ?? 0),
            'hero_overlay_color'         => TM_Helpers::sanitize_hex($input['hero_overlay_color'] ?? '#ffffff', '#ffffff'),
            'hero_overlay_opacity'       => max(0, min(100, absint($input['hero_overlay_opacity'] ?? 74))),
        );
    }
